...
class ApiService {
  ...
  Future<String> getServiceData({
    ...
    try {
      ...
      logger.e('ERROR get service: $e');
      return 'ERROR get service';
    }
  ...
  Future<String> getSharedLinks({
    ...
    final String apiUrl = "$baseDevApiUrl/v1.0/shared_links?customer_id=$customerId&page=$page&per_page=$perPage";
    try {
      SharedPreferences prefs = await SharedPreferences.getInstance();
